    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        validerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(ModifieOffreActivity2.this);
                builder.setMessage("Êtes-vous sûr de vouloir Modifier ?");
                builder.setPositiveButton("Oui", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {

                        Toast.makeText(ModifieOffreActivity2.this, "Félicitations Votre Offre est Modifier Avec succée", Toast.LENGTH_SHORT).show();
                    }
                });
                builder.setNegativeButton("Non", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(ModifieOffreActivity2.this, "OK", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        profileLogo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ModifieOffreActivity2.this, AfficheProfileActivity2.class);
        ...
        homephoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ModifieOffreActivity2.this, acceuilprofileActivity2.class);
                startActivity(intent);
            }
        });
